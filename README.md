...
博客内所有文章除特別声明外，均采用 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh) 许可协议。转载请注明来源 [MiaoTony](https://miaotony.xyz) !  
...
<p><img src="https://miaotony.xyz/2021/02/03/CTF_2021chunqiu/image-20210201202652728.png" /></p>
<h2 id="引言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#引言" title="引言"></a>引言</h2><p>前几天有个 2021年“春秋杯”新年欢乐赛，总共有 10  


### CTF | 限制长度下的命令执行 技巧汇总
[#CTF](https://miaotony.xyz/categories/CTF/)   [#CTF](https://miaotony.xyz/tags/CTF/)   [#Notes](https://miaotony.xyz/tags/Notes/)   [#Tricks](https://miaotony.xyz/tags/Tricks/)   
...
<h2 id="前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#前言" title="前言"></a>前言</h2><p>最近打 CTF 的时候遇到了个 <strong>命令执行</strong> 的 web  
...
<p>喵喵，最近 CTF 比较多，摸鱼起来比较忙，以至于好几篇博客都咕了。</p>
<p>噢我数数，一篇两篇，不对，已经在路上了 2333。</p>
<p>这篇居然就成了 <strong>2021 年的新年第一篇</strong>，那先 <strong>祝大家新年快乐喵~</strong>  
...
<p><img src="https://miaotony.xyz/2020/12/28/CTF_2020zongheng/image-20201228143836286.png" /></p>
<h2 id="引言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#引言" title="引言"></a>引言</h2><p>呜，转眼就到 2020  


### Install Terminal + git-bash + zsh + oh-my-zsh on Windows 10
[#Tech](https://miaotony.xyz/categories/Tech/)   [#Server](https://miaotony.xyz/categories/Tech/Server/)   [#Tech](https://miaotony.xyz/tags/Tech/)   [#Server](https://miaotony.xyz/tags/Server/)   [#Configuration](https://miaotony.xyz/tags/Configuration/)   [#Terminal](https://miaotony.xyz/tags/Terminal/)   [#bash](https://miaotony.xyz/tags/bash/)   [#zsh](https://miaotony.xyz/tags/zsh/)   
...
<h2 id="前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#前言" title="前言"></a>前言</h2><p>一直以来在 Windows 10 上一般是直接用自带的 cmd 或者 PowerShell，感觉界面是挺丑的。</p>
<p>另一方面在 Linux 环境下用 zsh 加了自动补全用着就贼爽，于是就想到能不能在  


### 碎碎念 | X-NUCA 2020 全国高校网安联赛总决赛 深圳游记
[#Life](https://miaotony.xyz/categories/Life/)   [#Life](https://miaotony.xyz/tags/Life/)   [#CTF](https://miaotony.xyz/tags/CTF/)   
...
<p><img src="https://miaotony.xyz/2020/12/10/Life_2020XNUCA_trip/image-20201210144231392.png" /></p>
<h2 id="前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#前言" title="前言"></a>前言</h2><p>这几天去深圳打了个 X-NUCA 2020  
...
<p><img src="https://miaotony.xyz/2020/11/23/CTF_2020NJUPTCTF/image-20201123214801335.png" /></p>
<h2 id="引言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#引言" title="引言"></a>引言</h2><p>一年一度的 NCTF  


### 基于Vercel Serverless部署Calc114514 API & Telegram bot
[#Tech](https://miaotony.xyz/categories/Tech/)   [#Projects](https://miaotony.xyz/categories/Tech/Projects/)   [#Tech](https://miaotony.xyz/tags/Tech/)   [#Projects](https://miaotony.xyz/tags/Projects/)   [#Web](https://miaotony.xyz/tags/Web/)   [#Server](https://miaotony.xyz/tags/Server/)   [#Serverless](https://miaotony.xyz/tags/Serverless/)   [#Vercel](https://miaotony.xyz/tags/Vercel/)   [#Telegram](https://miaotony.xyz/tags/Telegram/)   
...
<h2 id="0x00-Preface-前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#0x00-Preface-前言" title="0x00 Preface 前言"></a>0x00 Preface 前言</h2><p>最近，受到 USTC Hackergame 2020（中国科学技术大学第七届信息安全大赛）超精巧的数字论证器  
...
<h2 id="前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#前言" title="前言"></a>前言</h2><p>一年一度的 USTC Hackergame 又来了。</p>
<blockquote>
...
<h2 id="前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#前言" title="前言"></a>前言</h2><p>南邮的师傅们整了个 0xGame，比赛持续了一个月，每周放出一定的题目。</p>
<p>大概看了看，题目还是有点意思的。</p>
<blockquote>
<p>比赛平台：<a  
...
<h2 id="前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#前言" title="前言"></a>前言</h2><p><img src="https://miaotony.xyz/2020/10/26/CTF_2020bilibiliSec1024/83b92f73637ab8056346bb6b8a3af6d9840e8bb0.jpg" /></p>
<p>Bilibili  


### CTF | 2020 CISCN 国赛总决赛 部分解题复现
[#CTF](https://miaotony.xyz/categories/CTF/)   [#CTF](https://miaotony.xyz/tags/CTF/)   [#WriteUp](https://miaotony.xyz/tags/WriteUp/)   [#CISCN](https://miaotony.xyz/tags/CISCN/)   
...
<h2 id="前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#前言" title="前言"></a>前言</h2><p>好不容易经过线上初赛、分区选拔赛，终于有机会去线下打了场 CTF 国赛，感谢大师傅们带我玩~</p>
<p>辣鸡平台（ylbnb）什么的就不吐槽了，总的来说国赛其实还挺爽的  


### 环境搭建之更换软件源汇总(Ubuntu/pip/Anaconda/Docker等)
[#Tech](https://miaotony.xyz/categories/Tech/)   [#Server](https://miaotony.xyz/categories/Tech/Server/)   [#Tech](https://miaotony.xyz/tags/Tech/)   [#Server](https://miaotony.xyz/tags/Server/)   [#Configuration](https://miaotony.xyz/tags/Configuration/)   [#换源](https://miaotony.xyz/tags/%E6%8D%A2%E6%BA%90/)   
...
<p><img src="https://miaotony.xyz/2020/08/31/CTF_2020GACTF/d7499bfe36874a5aaa7c76c413991efb.jpg" /></p>
<h2 id="引言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#引言" title="引言"></a>引言</h2><p>这几天有个  


### CTF | 2020 CISCN初赛 Z3&LFSR WriteUp
[#CTF](https://miaotony.xyz/categories/CTF/)   [#CTF](https://miaotony.xyz/tags/CTF/)   [#WriteUp](https://miaotony.xyz/tags/WriteUp/)   [#Z3](https://miaotony.xyz/tags/Z3/)   
...
<h2 id="引言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#引言" title="引言"></a>引言</h2><p>喵呜，好久没来写博客了咕咕咕（这就来除草了！</p>
<p>前不久水了一波 CISCN 线上初赛，感谢队友带我玩带我飞~</p>
<p>这里来写一写 Z3、LFSR 这两题的 WriteUp，顺便记录一下用到的  
...
<h2 id="引言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#引言" title="引言"></a>引言</h2><p><strong>吸喵喵，冲冲冲！</strong></p>
<p>期待已久的 2020 NUAACTF  
...
<h2 id="引言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#引言" title="引言"></a>引言</h2><p><img src="/2020/05/24/CTF_BJDCTF3rd/poster.jpg"  
...
<p><img src="https://miaotony.xyz/2020/05/04/CTF_2020De1CTF/b1532fb9c0444888a6b2ce5d56cbf1f5.png" /></p>
<h2 id="引言"><a href="#引言" class="headerlink"  


### Ubuntu16.04配置TensorFlow-vGPU环境
[#Tech](https://miaotony.xyz/categories/Tech/)   [#Server](https://miaotony.xyz/categories/Tech/Server/)   [#Tech](https://miaotony.xyz/tags/Tech/)   [#Server](https://miaotony.xyz/tags/Server/)   [#Configuration](https://miaotony.xyz/tags/Configuration/)   [#Ubuntu](https://miaotony.xyz/tags/Ubuntu/)   [#tensorflow](https://miaotony.xyz/tags/tensorflow/)   [#GPU](https://miaotony.xyz/tags/GPU/)   
...
<h2 id="0x00-前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#0x00-前言" title="0x00 前言"></a>0x00 前言</h2><p>众所周知，机器学习对于计算机的算力要求很高，而 GPU 中的并行计算能有效地提高计算效率。NVIDIA 家的 GPU 大都支持 CUDA<em>（Compute Unified  
...
<p><img src="https://miaotony.xyz/2020/04/25/CTF_2020DASCTF_April/82776dfcc2e88aa4a379b152a12448c2.png" /></p>
<h2 id="前言"><a href="#前言" class="headerlink"  
...
<h2 id="前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#前言" title="前言"></a>前言</h2><p>看 CTF 群里有大佬引流，说周末西北瓜大（NPU）有个 CTF 比赛，<strong>据说对萌新比较友好</strong>，于是就来看了看。</p>
<p><strong>官方平台地址：</strong><a  


### 数据科学 | 十分钟入门pandas/常用方法笔记
[#DataScience](https://miaotony.xyz/categories/DataScience/)   [#Python](https://miaotony.xyz/tags/Python/)   [#Develop](https://miaotony.xyz/tags/Develop/)   [#DataScience](https://miaotony.xyz/tags/DataScience/)   [#pandas](https://miaotony.xyz/tags/pandas/)   
...
<p><img alt="pandas" src="https://miaotony.xyz/2020/04/17/DataScience_10MinutesToPandas/pandas.jpg" /></p>
<h2 id="0x00-前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#0x00-前言" title="0x00 前言"></a>0x00  


### 基于acme.sh从Let's encrypt生成免费且自动更新的SSL证书
[#Tech](https://miaotony.xyz/categories/Tech/)   [#Server](https://miaotony.xyz/categories/Tech/Server/)   [#Tech](https://miaotony.xyz/tags/Tech/)   [#Web](https://miaotony.xyz/tags/Web/)   [#Server](https://miaotony.xyz/tags/Server/)   [#Configuration](https://miaotony.xyz/tags/Configuration/)   [#SSL](https://miaotony.xyz/tags/SSL/)   
...
<h2 id="0x00-前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#0x00-前言" title="0x00 前言"></a>0x00 前言</h2><p>3月26日，一堆 GitHub Pages 以及 jd.com 等网站的 SSL 证书被一个自签名证书 （<code>C=CN; ST=GD; L=SZ; O=COM;  
...
<h2 id="引言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#引言" title="引言"></a>引言</h2><blockquote>
<p>本届BJDCTF由江苏科技大学、北京工业大学、西南民族大学、杭州师范大学、 江苏大学、湖南工业大学（排名不分先后）联合举办</p>
</blockquote>
<p>划水划水~ 周末水了一下  
...
<p><img alt="poster" src="https://miaotony.xyz/2020/03/15/CTF_2020XCTF_gxzy/poster.jpg" /></p>
<h2 id="前言"><a class="headerlink" href="https://miaotony.xyz/atom.xml#前言" title="前言"></a>前言</h2><p>上上周看到了这个 XCTF  


### CTF | JetBrains Quest 3 WriteUp/攻略
[#CTF](https://miaotony.xyz/categories/CTF/)   [#CTF](https://miaotony.xyz/tags/CTF/)   [#WriteUp](https://miaotony.xyz/tags/WriteUp/)   
2020-03-14 00:30 UTC+8  
[https://miaotony.xyz/2020/03/14/CTF_2020JetBrainsQuest3/](https://miaotony.xyz/2020/03/14/CTF_2020JetBrainsQuest3/)  

<h2 id="Cause"><a class="headerlink" href="https://miaotony.xyz/atom.xml#Cause" title="Cause"></a>Cause</h2><p>晚上看到 JetBrains 最后一个 Quest 出来了，于是继续来解个谜吧！</p>
<p>前两个 JetBrainsQuest 的 WriteUp 在这里↓呢。</p>
<p><a  
